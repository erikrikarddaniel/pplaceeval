...
**pplaceeval** Evaluates phylogenetic placement versus classification with hierarchical hmm profiles using the [nf-core/phyloplace](https://nf-co.re/phyloplace) pipeline.
...
3. Download the pipeline and test it on a minimal dataset with a single command:
   ...
   ```bash
   nextflow run erikrikarddaniel/pplaceeval -profile test,YOURPROFILE --outdir <OUTDIR>
   ```
